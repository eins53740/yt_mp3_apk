...
- [x] **ARCH-03**: Errors displayed as user-friendly messages with retry option (no stack traces)
- [x] **ARCH-04**: URL field preserved on download failure (user doesn't have to re-enter)
